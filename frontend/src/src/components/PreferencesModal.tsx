...
export default function PreferencesModal({ isOpen, onClose, onSaved }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 bg-card border border-border rounded-xl w-full max-w-lg flex flex-col animate-fade-slide-up">
        {/* Header */}
        <div className="flex items-center justify-between p-5 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-display text-base font-bold">Planner Preferences</h2>
          </div>
          <button onClick={onClose} className="h-7 w-7 rounded-lg flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors">
            <X className="h-4 w-4" />
          </button>
        </div>
